...
- make selection in table work on command key on Mac ([#1411](https://github.com/Angular-RU/angular-ru-sdk/issues/1411))
...
- add column id info to context menu in table header ([#1358](https://github.com/Angular-RU/angular-ru-sdk/issues/1358))
...
- filter descriptor to contain one of several values ([#1324](https://github.com/Angular-RU/angular-ru-sdk/issues/1324))

...
export function unwrap<T>(target: T, options: ObjectExtraOptions): T {
...
export function comparable<T>(target: T | T[] | string, options: ObjectExtraOptions = {}): ComparableKeys<T> {

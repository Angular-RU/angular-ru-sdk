...
describe('[TEST]: Join Pipe', () => {
    it('only separator', () => {
        ...
        expect(new JoinPipe().transform([1, 2], { separator: ', <br> ' })).toBe('1, <br> 2');
        expect(new JoinPipe().transform([1, 2, 3], { separator: ', <br> ' })).toBe('1, <br> 2, <br> 3');
        expect(new JoinPipe().transform([1, 2, 3], { separator: ' :: ' })).toBe('1 :: 2 :: 3');
    });

...
import {FilterDescriptor} from '../../../virtual-table/services/filterable/filter-descriptor';
...
describe('[TEST] Table builder', (): void => {
    ...
    it('should correctly filter table', async (): Promise<void> => {
        ...
        tableBuilderComponent.filterable.setDefinition([
            {
                value: 'iv, sidor',
                type: TableFilterType.CONTAINS_ONE_OF_VALUES,
                key: 'lastName',
            },
        ]);
        await tableBuilderComponent.sortAndFilter();
        ...
        tableBuilderComponent.filterable.setDefinition([
            {value: 3, type: TableFilterType.DOES_NOT_EQUAL, key: 'id'},
        ]);
        await tableBuilderComponent.sortAndFilter();
        ...
        tableBuilderComponent.filterable.setDefinition([
            {value: 3, type: TableFilterType.EQUALS, key: 'id'},
        ]);
        await tableBuilderComponent.sortAndFilter();
        ...
        tableBuilderComponent.filterable.setDefinition([
            {value: true, type: TableFilterType.IS_FILLED, key: 'name'},
        ]);
        await tableBuilderComponent.sortAndFilter();
        ...
        tableBuilderComponent.filterable.setDefinition([
            {value: 2, type: TableFilterType.MORE_OR_EQUAL, key: 'id'},
        ]);
        await tableBuilderComponent.sortAndFilter();
        ...
        tableBuilderComponent.filterable.setDefinition([
            {value: 2, type: TableFilterType.LESS_THAN, key: 'id'},
        ]);
        await tableBuilderComponent.sortAndFilter();
        ...
        tableBuilderComponent.filterable.setDefinition([
            {value: 2, type: TableFilterType.LESS_OR_EQUAL, key: 'id'},
        ]);
        await tableBuilderComponent.sortAndFilter();

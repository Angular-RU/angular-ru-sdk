import { MarkByFilterPipe, MarkByFilterPipeModule } from '@angular-ru/common/pipes';
...
describe('mark by filter pipe', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({ imports: [MarkByFilterPipeModule] }).compileComponents();

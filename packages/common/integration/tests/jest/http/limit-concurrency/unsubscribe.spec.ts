...
import { DataHttpClient, DataHttpClientModule } from '@angular-ru/common/http';
...
describe('[TEST]: Canceling requests and unsubscribing', () => {
    ...
    class TestComponent implements OnInit, OnDestroy {
        ...
        constructor(public readonly api: ApiClient) {}
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            imports: [
                ...
                DataHttpClientModule.forRoot([ApiClient], { limitConcurrency: limitConcurrency })
            ]
        });

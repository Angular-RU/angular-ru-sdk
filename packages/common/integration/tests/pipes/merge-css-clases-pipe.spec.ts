...
import { MergeCssClassesPipe, MergeCssClassesPipeModule } from '@angular-ru/common/pipes';

describe('merge css classes pipe', (): void => {
    let pipe: MergeCssClassesPipe;

    beforeEach((): void => {
        TestBed.configureTestingModule({ imports: [MergeCssClassesPipeModule] }).compileComponents();

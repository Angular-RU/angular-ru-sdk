...
2. [📦 Advanced](#table-of-contents)
    ...
    - [(@)angular-ru/common/date-suggestion](https://github.com/Angular-RU/angular-ru-sdk/blob/master/packages/common/docs/date-suggestion.md)
    ...
    - [(@)angular-ru/common/node.js](https://github.com/Angular-RU/angular-ru-sdk/blob/master/packages/common/docs/node.js.md)

# 🎁 Release notes (`23.01.2022 21:27`)
...
# 🎁 Release notes (`24.01.2022 21:27`)

## Changes

-   chore(eslint-config-enterprise): release version 12.66.0 [ci skip]
-   chore(ngxs): release version 12.66.0 [ci skip]
-   chore(cdk): release version 12.66.0 [ci skip]
-   feat(eslint-config-enterprise): support no-array-for-each
-   chore: update RELEASE_NOTE
-   chore: update RELEASE_NOTE
-   chore: remove redundant (#1226)
-   ci: cleanup package.json
-   chore: updated RELEASE_NOTES.md [ci skip]

## Metadata

```
This version -------- @angular-ru/eslint-config-enterprise-12.66.0
...
# 🎁 Release notes (`27.02.2022 23:14`)

## Changes

-   chore(dev-dependencies): release version 12.64.4 [ci skip]
-   build: update dependency @types/node to v17.0.21 (#1245)
-   chore: updated RELEASE_NOTES.md [ci skip]

## Metadata

```
This version -------- @angular-ru/dev-dependencies-12.64.4
...
# 🎁 Release notes (`18.05.2022 14:25`)

## Changes

-   chore(cdk): release version 13.1.1 [ci skip]
-   chore(jest): release version 13.0.3 [ci skip]
-   chore(prettier): release version 13.0.2 [ci skip]
-   chore(commitlint): release version 13.0.2 [ci skip]
-   chore(dev-dependencies): release version 13.0.2 [ci skip]
-   chore(eslint-config-enterprise): release version 13.0.6 [ci skip]
-   style: formatting (#1285)
-   chore: updated RELEASE_NOTES.md [ci skip]

## Metadata

```
This version -------- @angular-ru/cdk-13.1.1
...
# 🎁 Release notes (`26.05.2022 20:08`)

## Changes

-   chore(cdk): release version 13.1.3 [ci skip]
-   chore(jest): release version 13.0.5 [ci skip]
-   chore(prettier): release version 13.0.4 [ci skip]
-   chore(commitlint): release version 13.0.4 [ci skip]
-   chore(dev-dependencies): release version 13.0.4 [ci skip]
-   chore(eslint-config-enterprise): release version 13.0.8 [ci skip]
-   build: update dependency husky to v8 (#1293)
-   chore: updated RELEASE_NOTES.md [ci skip]

## Metadata

```
This version -------- @angular-ru/cdk-13.1.3
